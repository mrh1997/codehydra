<script lang="ts">
	...
	// Animation duration in ms - keep in sync with CSS --bounce-duration
	...
	async function handleDiscussionMouseUp(event: MouseEvent) {
		...
		<div class="discussion-scroll-area" bind:this={discussionScrollArea}>
			...
			<div class="discussion-thread" onmouseup={handleDiscussionMouseUp}>
				...
				{:else}
					...
					{#each discussionMessages as message, index}
						<div
